...
union ExitInstructionInformation
{
    // ins, outs instructions use this field.
    struct
    {
        unsigned long reserved1 : 7;			// Bits	0-6
        unsigned long address_size : 3;			// Bits 7-9
        unsigned long reserved2 : 5;			// Bits 10-14
        unsigned long segment : 3;				// Bits 15-17
        unsigned long reserved3 : 14;			// Bits 18-31
    }f0;
    // invept, invpcid, invvpid instructions use this field.
    struct
    {
        unsigned long scaling : 2;				// Bits	0-1
        unsigned long reserved1 : 5;			// Bits	2-6
        unsigned long address_size : 3;			// Bits 7-9
        unsigned long reserved2 : 5;			// Bits	10-14
        unsigned long segment : 3;				// Bits 15-17
        unsigned long index : 4;				// Bits 18-21
        unsigned long index_invalid : 1;		// Bit	22
        unsigned long base : 4;					// Bits	23-26
        unsigned long base_invalid : 1;			// Bit	27
        unsigned long reg2 : 4;					// Bits	28-31
    }f1;
    ...
    struct
    {
        ...
        unsigned long reserved1 : 5;			// Bits	2-6
        unsigned long address_size : 3;			// Bits 7-9
        unsigned long reserved2 : 1;			// Bit	10
        unsigned long operand_size : 1;			// Bit	11
        unsigned long reserved3 : 3;			// Bits	12-14
        unsigned long segment : 3;				// Bits 15-17
        unsigned long index : 4;				// Bits 18-21
        unsigned long index_invalid : 1;		// Bit	22
        unsigned long base : 4;					// Bits	23-26
        unsigned long base_invalid : 1;			// Bit	27
        unsigned long is_idtr_access : 1;		// Bit	28
        unsigned long is_loading : 1;			// Bit	29
        unsigned long reserved4 : 2;			// Bits	30-31
    }f2;
    // lldt, ltr, sldt, str instructions use this field.
    struct
    {
        unsigned long scaling : 2;				// Bits	0-1
        unsigned long reserved1 : 1;			// Bit	2
        unsigned long reg1 : 4;					// Bits	3-6
        unsigned long address_size : 3;			// Bits 7-9
        unsigned long use_register : 1;			// Bit	10
        unsigned long reserved2 : 4;			// Bits	11-14
        unsigned long segment : 3;				// Bits 15-17
        unsigned long index : 4;				// Bits 18-21
        unsigned long index_invalid : 1;		// Bit	22
        unsigned long base : 4;					// Bits	23-26
        unsigned long base_invalid : 1;			// Bit	27
        unsigned long is_tr_access : 1;			// Bit	28
        unsigned long is_loading : 1;			// Bit	29
        unsigned long reserved3 : 2;			// Bits	30-31
    }f3;
    // rdrand, rdseed, tpause, umwait instructions use this field.
    struct
    {
        unsigned long reserved1 : 3;			// Bits	0-2
        unsigned long operand_reg : 4;			// Bits 3-6
        unsigned long reserved2 : 4;			// Bits 7-10
        unsigned long operand_size : 2;			// Bits 11-12
        unsigned long reserved3 : 19;			// Bits 13-31
    }f4;
    ...
    struct
    {
        ...
        unsigned long base : 4;					// Bits	23-26
        unsigned long base_invalid : 1;			// Bit	27
        unsigned long instruction_id : 2;		// Bits	28-29
        unsigned long reserved3 : 2;			// Bits	30-31
    }f5;
    ...
    struct
    {
        unsigned long reserved0 : 3;			// Bits	0-2
        unsigned long reg1 : 4;					// Bits	3-6
        unsigned long reserved1 : 21;			// Bits	7-27
        unsigned long reg2 : 4;					// Bits	28-31
    };
    unsigned long value;
};
